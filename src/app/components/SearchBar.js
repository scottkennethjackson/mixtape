    ...
    <div className="SearchBar flex flex-col my-8 space-y-4">
      <div className="flex items-center rounded-full bg-white py-2 px-4">
        ...
        <input 
          ...
          className=" w-64 focus:outline-none rounded-r-full text-center text-black"
          placeholder="Enter a Song, Artist or Album"
        />
      </div>
      <button onClick={passTerm} className="SearchButton mx-auto w-fit rounded-full bg-lightblue hover:bg-hoverblue active:bg-activeblue py-2 px-4 text-black">SEARCH</button>
    </div>
  );
};
